    ...
    <section>
      <div className="container mx-auto bg-slate-600 max-w-none">
        ...
        >
          ...
          <div className="z-20 flex flex-col gap-y-8 text-white items-center">
            ...
            <p className="text-md xl:text-2xl font-light w-9/12">
              {movie.overview}
            </p>
            {movie.genres && (
              <div className="flex items-center justify-center gap-x-3 gap-y-3 flex-col md:flex-row ">
